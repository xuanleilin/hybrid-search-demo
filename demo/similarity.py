...
# Default file paths
DEFAULT_INTERACTION_FILE = "input/implicit_lf_dataset.csv"
DEFAULT_OUTPUT_FILE = "output/similar_songs.csv"
...
def find_similar_songs(song_signatures, song_to_users, lsh):
...
def main():
    ...
    similar_pairs = find_similar_songs(song_signatures, song_to_users, lsh)
